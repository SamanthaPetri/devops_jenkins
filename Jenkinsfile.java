  ...
  stages {
    ...
    stage('Deploy to Octopus') {
            steps {
                ...
                bat 'octo deploy-release --project=sit --releaseNumber=0.0.9 --deployTo=Production --server=https://petri.octopus.app --apiKey=API-WA08EUGBXYFUEAMAW2JHUEXJE7B55DJF'
            }
        }
